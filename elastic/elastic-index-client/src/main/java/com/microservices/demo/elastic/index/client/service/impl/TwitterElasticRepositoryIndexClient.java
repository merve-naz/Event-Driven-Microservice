...
// @Primary: Projede aynı arayüzü (ElasticIndexClient) uygulayan birden fazla sınıf var.
// Spring'e "Veri kaydedileceği zaman öncelikle bu sınıfı (Repository yöntemini) baz al" diyoruz.
@Primary
@Service
